...
export async function POST(request) {
  try {
    ...
    await transporter.sendMail({
      ...
      to: email,
      subject: "Welcome to ShopKart Newsletter!",
      html: `
        <!DOCTYPE html>
<html>
            ...
            <tr>
              <td align="center" style="padding-bottom:14px;">
                <a href="${process.env.NEXT_BASE_URL}" target="_blank">
                  ...
                  }/logo.png" alt="ShopKart" style="width:84px;height:84px;border-radius:24px;display:block;border:2px solid #35530e;">
                </a>
              </td>
            </tr>
            <!-- Heading -->
            <tr>
              <td align="center" style="font-family:sans-serif;color:#35530e;">
                <h2 style="margin:8px 0 0 0;font-size:1.7rem;font-weight:900;letter-spacing:1px;">Welcome to <span style="color:#6ccf4e;">ShopKart</span>!</h2>
                <div style="font-size:1.1rem;font-weight:600;letter-spacing:.2px;margin:0 0 14px 0;color:#35530e;">You’re on the list for exclusive deals & style!</div>
              </td>
            </tr>
            <!-- Coupon and Offer -->
            <tr>
              <td align="center" style="padding:12px 0;">
                ...
                <div style="font-size:1rem;color:#4d6537;margin-top:10px;">
                  <a href="${
                    process.env.NEXT_BASE_URL
                  }/shop" style="color:#fff;background:#35530e;padding:10px 30px;border-radius:24px;text-decoration:none;font-weight:600;display:inline-block;margin-top:12px;">
                    Start Shopping &rarr;
                  </a>
                </div>
              </td>
            ...
            <tr>
              <td align="center" style="font-size:0.9rem;color:#999;padding-top:12px;">
                ...
                <div>
                  ...
                  &copy; ShopKart ${new Date().getFullYear()}
                </div>
              </td>
            </tr>
          </table>
