          ...
          <form className="mt-8 space-y-4" onSubmit={handleSubmit}>
            ...
            <div className="relative">
              <select
                ...
                className="appearance-none w-full px-3 py-2 rounded-md bg-white text-black border border-gray-300 focus:outline-none focus:ring-2 focus:ring-[#35530e]"
              >
            ...
            <div className="flex items-center">
              <input
                ...
                onChange={updateFormData}
                className="h-4 w-4 text-[#35530e] border-gray-300 rounded"
              />
              <label
