  ...
  return (
    <div
      className="
        ...
        aspect-[4/5] sm:aspect-square md:aspect-video xl:aspect-[2.8/1]
        min-h-[260px] sm:min-h-[300px] md:min-h-[380px]
      "
      ...
      {slides.map((slide, idx) => {
        ...
        return (
          ...
          >
            ...
            {/* Overlay & text */}
            <div className="absolute inset-0 bg-black/40 flex flex-col justify-center items-start px-6 sm:px-14 xl:px-28">
